# DISCLAIMER:
# TO USE THIS SCRIPT, YOU MUST COPY THIS ENTIRE DOCUMENT 
# (COMMAND A, or ⌘ + A)
# Paste the contents into a Python interpreter website.
"""
(https://onecompiler.com/python is recommended, ->
although any supporting Python 3.x will work fine)
"""
# Scroll down until you find the part that says 
# "data = randdataset(4, 1, 10)"
# Replace "randdataset(4, 1, 10)" with your dataset,
# formatted as such (it’s an example):
# Your data: 5, 9, 1, 8
# Line is replaced with: "data = [5, 9, 1, 8]"
# (No, you do not have to sort it.)


"""
I am ilovapples on most websites.
(except Reddit, where I’m CraftMaster6875)

Go to 
>>> https://github.com/ilovapples <<<
for my work.


If you want to reach out to me, use my discord!: ilovapples#6004


TITLE: Statistical Calculation on Data Automator (SCDA)
